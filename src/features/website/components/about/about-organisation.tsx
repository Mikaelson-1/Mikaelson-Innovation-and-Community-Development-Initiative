export const AboutOrganization: React.FC = () => (
  <section className="about-organization mt-16 bg-gray-50 py-12 text-center">
    <div className="mx-auto max-w-4xl rounded-2xl border border-black/10 bg-white/80 p-10 text-left shadow">
      ...
      <div className="mb-6 rounded-xl border border-amber-500 bg-amber-100 p-4">
